...
RSpec.describe "/students", type: :request do
  ...
  let(:valid_attributes) {
    { first_name: 'First', lastname: 'last', phone: '1234567890', age: 20 }
  }

  let(:invalid_attributes) {
    { first_name: 'First', lastname: 'last', phone: '1234567890', age: 'dasdsa'}
  }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      let(:new_attributes) {
        { first_name: "two", lastname: "zzzz", phone: "1234567899", age: 10 }
      }
